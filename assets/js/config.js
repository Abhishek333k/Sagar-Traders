...
function saveSettingsState() { 
    localStorage.setItem('sagar_settings', JSON.stringify({ invMode: document.getElementById('invMode').value, activeUpiId, activeBankId })); 
}
...
function handleLogoUpload(input) {
    ...
    reader.onload = function(event) {
        ...
        img.onload = function() {
            ...
            systemConfig.logoUrl = canvas.toDataURL('image/jpeg', 0.7);
            markSettingsDirty(); applySystemConfig();
        }
    }
}
